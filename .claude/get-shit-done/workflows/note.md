...
- **Global scope**: `/Users/chiendam/Dev/Projects/real_estate/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/chiendam/Dev/Projects/real_estate/.claude/notes/`)
...
2. Glob `/Users/chiendam/Dev/Projects/real_estate/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/chiendam/Dev/Projects/real_estate/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/chiendam/Dev/Projects/real_estate/.claude/notes/` — works in any directory
